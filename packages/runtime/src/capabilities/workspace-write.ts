// Workspace-escape-guarded file write for the core upload-materialization
// capability.
//
// The materialize skill script carries a deliberate copy of this module
// (skills/attachments/scripts/workspace-write.ts): skill scripts must stay
// self-contained (no runtime-source imports) so the skill stays portable. If
// you change the guard logic, change BOTH copies — each carries this pointer
// and its own test suite pins the behavior.
//
